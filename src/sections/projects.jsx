                ...
                {projects.map(project=>(
                    <div key= {project.id}>
                        ...
                        <div className='bg-gray-900 rounded-br-2xl rounded-bl-2xl px-4 py-6'>
                            ...
                            <a className='px-6 py-3 flex items-center gap-2 capitalize font-semibold bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-md'
                            ...
                            <a className='px-6 py-3 flex items-center gap-2 capitalize font-semibold bg-gray-600 hover:bg-blue-700 duration-200 ease-in text-white rounded-md'
